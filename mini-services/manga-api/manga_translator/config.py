...
def translator_chain(string):
    try:
        ...
        raise argparse.ArgumentTypeError(f'Invalid translator_chain value: "{string}". Example usage: --translator "groq" -l "JPN:ENG"')
...
class Translator(str, Enum):
    ...
    mimo_token_plan_v25 = "mimo_token_plan_v25"
    google = "google"
...
class TranslatorConfig(BaseModel):
    ...
    """Output of one translator goes in another. Example: --translator-chain "groq:JPN;groq:ENG"."""
    selective_translation: Optional[str] = None
    """Select a translator based on detected language in image. Note the first translation service acts as default if the language isn't defined. Example: --translator-chain "groq:JPN;groq:ENG"."""
    ...
    mimo_token: Optional[str] = None
    """MiMo Token Plan API key (formato tp-xxxxx), pasado por request o extensión."""
    mimo_model: Optional[str] = None
    """MiMo Token Plan model, pasado por request o extensión."""
    groq_key: Optional[str] = None
    """Groq API key."""
    groq_model: Optional[str] = None
    """Groq model."""
    ollama_model: Optional[str] = None
    """Ollama/OpenAI Custom model."""

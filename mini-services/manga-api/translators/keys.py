...
# MiMo Token Plan (Xiaomi MiMo API — https://token-plan-sgp.xiaomimimo.com/v1)
# Formato de clave: tp-xxxxx
MIMO_TOKEN_PLAN_API_KEY = os.getenv('MIMO_TOKEN_PLAN_API_KEY', '')
MIMO_TOKEN_PLAN_API_BASE = os.getenv('MIMO_TOKEN_PLAN_API_BASE', 'https://token-plan-sgp.xiaomimimo.com/v1')
MIMO_TOKEN_PLAN_MODEL = os.getenv('MIMO_TOKEN_PLAN_MODEL', 'mimo-v2.5-pro')
